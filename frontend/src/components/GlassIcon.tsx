...
const GlassIcon: React.FC<GlassIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute top-0 left-0 w-full h-full rounded-[1.25em] bg-transparent transition-[opacity,transform] duration-300 ease-[cubic-bezier(0.83,0,0.17,1)] origin-[80%_50%] flex backdrop-blur-[0.75em] [-webkit-backdrop-filter:blur(0.75em)] transform group-hover:[transform:translateZ(2em)]"
        style={{
